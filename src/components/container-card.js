...
const ContainerCard = ({
  ...
  return (
    <FrameParentRoot>
      <FrameGroup>
        <GroupParent>
          <FrameChild alt="" src={componentGroupImageUrl} />
          <BitcoinParent>
            <Bitcoin>{cryptoImageUrl}</Bitcoin>
            <Btcusdt>{symbolImageUrl}</Btcusdt>
          </BitcoinParent>
        </GroupParent>
        <VectorIcon alt="" src={vectorImageUrl} propHeight={propHeight} />
      </FrameGroup>
      <FrameContainer>
        <PriceParent>
          <Price>Price</Price>
